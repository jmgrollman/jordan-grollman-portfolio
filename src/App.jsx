  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 60 }}>
        ...
        >
          COO at{" "}
          <a href="https://reppo.ai/" target="_blank" rel="noopener noreferrer" style={{ color: C.accent, textDecoration: "none" }}>
            Reppo Labs
          </a>{" "}
          | Founder of{" "}
          <a href="https://www.yallaathletics.com/" target="_blank" rel="noopener noreferrer" style={{ color: C.accent, textDecoration: "none" }}>
            Yalla
          </a>{" "}
          | 10+ years In partnerships at Facebook, Blockworks, & in Venture Capital.
        </p>
