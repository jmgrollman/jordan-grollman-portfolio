          ...
          {[
            {
              ...
              desc: "I build systems, processes, and teams that scale — especially in chaotic, fast-moving environments.",
            },
            {
              icon: "🤝",
              title: "Partnership Builder",
              desc: "8+ years cultivating relationships that drive revenue and create long-term strategic value.",
            },
            {
              icon: "🔮",
              title: "Thesis-Driven Investor",
              desc: "Focused on disruptive technology at the convergence of AI, Web3, DePIN, and emerging infrastructure.",
            },
            {
              icon: "🚀",
              title: "Early-Stage DNA",
              desc: "From employee #8 to COO — I thrive where ambiguity meets opportunity and nothing exists yet.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      >
        ...
        <div>
          ...
          >
            ...
            {/*
             * ✏️  TO EDIT: Replace the href="#" below with your actual
             *     Google Calendar / Calendly scheduling link, e.g.:
             *     href="https://calendly.com/jordan-grollman/30min"
             */}
            <a
              href="#"
              style={{
