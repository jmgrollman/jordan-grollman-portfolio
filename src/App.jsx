...
const PROJECTS = [
  ...
  {
    name: "Syntetika",
    tagline: "Synthetic Asset Protocol",
    url: "https://syntetika.io/",
    description:
      "Pioneering synthetic asset vaults enabling new forms of on-chain financial instruments and yield strategies for DeFi participants.",
  },
  {
    name: "Blockworks",
    tagline: "Crypto Media & Research",
...
const EXPERIENCE = [
  {
    ...
    company: "Reppo Labs",
    description:
      "Leading operations at a Crypto x AI infrastructure company building permissionless data exchange between data owners and AI developers/agents. Overseeing go-to-market, partnerships, and operational scaling as the company builds the connective tissue for the next generation of AI training data pipelines.",
    tags: ["AI", "Web3", "DePIN", "Data Infrastructure"],
  },
  {
    date: "2022 — 2024",
    role: "Director of Account Management & Sales Operations",
    company: "Blockworks",
    description:
      "Drove strategic partnerships and scaled revenue operations at one of crypto's leading media brands. Led account management teams, built sales infrastructure, and managed key enterprise relationships across the digital assets ecosystem.",
    tags: ["Crypto Media", "B2B", "Partnerships"],
  },
  {
    date: "2019 — 2022",
    role: "Founder & Managing Partner",
    company: "Grollman Holdings, LLC",
    description:
      "Founded a personal investment vehicle focused on early-stage bets in emerging technology, Web3, and consumer startups. Developed deal sourcing, due diligence frameworks, and portfolio management practices.",
    tags: ["Investing", "Startups", "Venture"],
  },
  {
    date: "2018 — 2019",
    role: "Customer Success & Operations",
    company: "Canopy (Employee #8)",
    description:
      "Built the entire customer success infrastructure from scratch at an early-stage SaaS startup. Scaled onboarding, retention, and support processes that supported rapid revenue growth during a critical growth phase.",
  ...
  },
  {
    ...
    description:
      "Managed advertising partnerships and helped brands scale their presence across Facebook and Instagram platforms. Developed expertise in digital advertising, data-driven marketing, and client relationship management.",
...
function ProjectCard({ project, index }) {
  ...
  const colors = [C.accent, C.pink, C.yellow, C.green, C.accent, C.pink];
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" }}>
        <StatusPill text="Advisor & Investor" color={C.yellow} />
      </div>
      <p
        style={{
          fontSize: 14,
  ...
  return (
    <div style={{ display: "flex", gap: 24, marginBottom: isLast ? 0 : 8 }}>
      ...
      >
        ...
        <div
          style={{ fontSize: 14, fontWeight: 600, color: C.accent, marginBottom: 12 }}
        >
          {item.company}
        </div>
        <p
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 60 }}>
        ...
        >
          Operating & Investing in Emerging Disruptive Tech
        </h2>
        <p
          style={{
            fontSize: 16,
        ...
        >
          COO at Reppo Labs — building the connective tissue between data owners
          and AI agents. 8+ years scaling partnerships, revenue, and teams across
          Web3, AI, and emerging tech.
        </p>

        {/* Skill Badges */}
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 36 }}>
          {["Web3", "AI / ML", "DePIN", "Operations", "Partnerships", "Crypto"].map(
            (s) => (
      ...
      <div>
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 15, color: C.textSec }}>
            Early-stage companies building across AI, DeFi, media, and consumer tech
          </p>
        </div>
        <div
          style={{
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        >
          Operations leader turned operator-investor with 8+ years building and
          scaling emerging tech companies. From early-stage startups to established
          media brands, I bring a customer-first mindset, entrepreneurial
          intensity, and a passion for disruptive technology to everything I do.
        </p>
      </div>
      ...
      <div style={{ marginBottom: 56 }}>
        ...
        >
          ...
          <div style={{ fontSize: 14, color: C.accent, marginBottom: 10 }}>
            B.S. Sports Management & Marketing
          </div>
          <p style={{ fontSize: 14, color: C.textSec, lineHeight: 1.7, margin: 0 }}>
            Sigma Alpha Mu Fraternity · Indiana University Sports Marketing
            Alliance · Music Vs. at Indiana University
          </p>
        </div>
      </div>

      {/* What I Bring — 2x2 grid, full width, bigger cards */}
      <div>
        <h2 style={{ fontSize: 24, fontWeight: 700, color: C.text, marginBottom: 28 }}>
          What I Bring
        </h2>
          ...
          {[
            {
              ...
              desc: "I build systems, processes, and teams that scale — especially in chaotic, fast-moving environments where nothing exists yet and everything needs to be created from scratch.",
            },
            {
              icon: "🤝",
              title: "Partnership Builder",
              desc: "8+ years cultivating relationships that drive revenue and create long-term strategic value. I put customers at the center and turn partnerships into compounding growth engines.",
            },
            {
              icon: "🔮",
              title: "Thesis-Driven Investor",
              desc: "Focused on disruptive technology at the convergence of AI, Web3, DePIN, and emerging infrastructure. I invest where I have conviction and roll up my sleeves to help founders win.",
            },
            {
              icon: "🚀",
              title: "Early-Stage DNA",
              desc: "From employee #8 to COO — I thrive where ambiguity meets opportunity. I've built customer success orgs from zero, launched go-to-market strategies, and scaled teams through hypergrowth.",
            },
          ].map((item) => (
            <div
              key={item.title}
